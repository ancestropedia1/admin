...
const Executive = () => {
  return (
    <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-md border border-[#E6E6E6] w-full h-auto min-h-[400px]">
      <h3 className="text-lg font-semibold border-b border-gray-300 pb-4">Recent Activities</h3>

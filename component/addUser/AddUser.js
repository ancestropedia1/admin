          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 xl:gap-10 mt-6">
            ...
            <div className="bg-[#F6F1E9] border border-gray-200 rounded-lg p-4 sm:p-6 md:p-8 shadow-sm w-full">
              <div className="mb-4 sm:mb-6">
                ...
                <p
                  className={`${lato.className} text-xs sm:text-sm md:text-base mt-1 text-gray-700`}
                >
                ...
                {[
                  {
                    ...
                    title: "Remember to input the user's full name, date of birth, and place of birth",
            ...
            <div className="bg-[#F6F1E9] border border-gray-200 rounded-lg p-4 sm:p-6 md:p-8 shadow-sm w-full">
              <h2
                className={`${playfair.className} sm:text-2xl md:text-3xl xl:text-3xl font-bold mb-3 sm:mb-5`}
              >
                Recent Activity
              </h2>
